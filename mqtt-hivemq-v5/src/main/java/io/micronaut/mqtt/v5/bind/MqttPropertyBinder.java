 ...
 * If the name is not one of the supported property names, the name and value will be populated via a {@link UserProperty}
 *
 * @author James Kleeh
 * @since 1.0.0
 * @see MqttProperties for a list of names
 */
